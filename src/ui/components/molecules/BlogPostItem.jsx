...
const BlogPostItem = ({post, loading}) => {
        ...
        <Container>
          <Row>
            <Col lg='8' md='10' className="mx-auto">
              <h2 className="section-heading">{post.title.toUpperCase()}</h2>
              <Link href>
                <Image className="img-fluid" imageUrl="https://www.aljazeera.com/mritems/imagecache/mbdxxlarge/mritems/Images/2020/5/1/970d361a783b40538332c4d7b32c6366_18.jpg" alt="" />
              </Link>
              ...
              <p>
                Science cuts two ways, of course; its products can be used for both good and evil. But theres no turning back from science. The early warnings about technological dangers also come from science.
              </p>
