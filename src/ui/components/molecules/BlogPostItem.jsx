...
const BlogPostItem = ({ post, loading, history }) => {
  if (Object.keys(post).length > 0) {
    return (
      <article>
        <Col lg="8" md="10" className="mx-auto">
          <h2 className="section-heading mb-4">{post.title.toUpperCase()}</h2>
          <Link to="#" href>
            <Image
              className="img-fluid"
              imageUrl="https://www.aljazeera.com/mritems/imagecache/mbdxxlarge/mritems/Images/2020/5/1/970d361a783b40538332c4d7b32c6366_18.jpg"
              alt=""
            />
          </Link>
          ...
          <p>
            ...
            good and evil. But theres no turning back from science. The early
          ...
          <p>
            ...
            Thats how I felt seeing the Earth for the first time. I could not
  ...
  return loading ? <AppLoader /> : <AppLoader />;
};
